    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link d-flex align-items-center" data-toggle="dropdown" href="#">
          ...
          <span class="d-none d-md-inline">{{ Auth::user()->name ?? 'Karyawan' }}</span>
        </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item mt-4 pb-4">
            <form action="{{ route('logout') }}" method="POST" id="sidebar-logout-form-karyawan">
              @csrf
              <a href="javascript:void(0)" onclick="document.getElementById('sidebar-logout-form-karyawan').submit();" class="nav-link text-danger">
